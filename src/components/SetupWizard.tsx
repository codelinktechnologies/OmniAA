...
export default function SetupWizard({ onComplete, onBackToSales }: SetupWizardProps) {
  ...
  const modesList = [
    ...
    },
    {
      ...
      title: "Browser Control Agent",
      description: "Navigate web pages, click elements, fill forms, and extract deep web data fully autonomously."
    },
    {
      id: AgentModeId.VOICE_CALLER,
      title: "Voice Caller Agent",
      description: "Places AI-powered voice calls to leads, confirming bookings and handling simple Q&A instantly."
    }
  ];
    ...
    <div id="setup-wizard-container" className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full mx-auto bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <div className="bg-slate-900 px-8 py-6 text-white flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold tracking-tight">OmniAgentAI v2.0 Setup</h2>
