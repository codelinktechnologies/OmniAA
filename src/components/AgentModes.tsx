...
import { 
  ...
  HelpCircle, Settings, MapPin, Sliders, Hash
} from "lucide-react";
...
I drafted a responsive customized scheduler for you guys here. Let me know if you want to check it out!`,
  ...
  return (
    <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden flex flex-col md:flex-row min-h-[550px]">
      ...
      <div className="w-full md:w-80 border-r border-slate-100 bg-slate-50/50 p-4 space-y-2 flex-shrink-0">
        <h3 className="text-xs font-bold font-mono text-slate-400 uppercase tracking-wider px-3 mb-4">6 Active Agent Skills</h3>
        {modesInfo.map((mode) => {
      ...
      <div className="flex-1 p-6 md:p-8 flex flex-col justify-between">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {/* Revenue Reporter Configuration */}
