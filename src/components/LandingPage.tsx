...
const PROMPT_PRESETS = [
  ...
  },
  {
    ...
    logs: [
      "✨ Built-In Revenue Engine active. Aggregating 24-hour workspace metrics...",
...
export default function LandingPage({ onLaunchDemo }: LandingPageProps) {
  ...
  const pricingTiers = [
    {
      name: "OmniAgentAI v2.0 (Launch)",
      priceMonthly: 57,
      priceYearly: 37,
      desc: "Get the complete Front-End product at a massive discount during our August 2026 Launch.",
      features: [
        "1 Active Virtual Assistant Space",
        "Voice & Browser Control Included",
        "Built-In Revenue Engine",
        "Direct WhatsApp / Telegram Sync",
        "Friendly setup wizard (no tech skills needed)",
        "Full step-by-step help videos"
      ],
      cta: "Secure Launch Pricing",
      popular: false
    },
    {
      name: "Autopilot Pro",
      ...
      features: [
        ...
        "8 NEW August Capabilities Added",
...
- Send a lovely birthday discount voucher automatically to regular clients.`;
  ...
  return (
    <div className="visible-white-mesh text-slate-900 font-sans min-h-screen selection:bg-purple-600 selection:text-white relative overflow-hidden">
      ...
      {/* Top Affiliate/JV Banner */}
      <div className="bg-indigo-900 text-indigo-50 px-4 py-2 text-center text-xs font-medium flex items-center justify-center space-x-4 relative z-50">
        <span className="font-bold text-white tracking-widest uppercase text-[10px] bg-indigo-800 px-2 py-0.5 rounded border border-indigo-700">JVZoo + LaunchPad</span>
        <span>August 2026 Launch Edition</span>
        <span className="opacity-60">•</span>
        <span>Projected EPS: <strong className="text-white">$166 per buyer</strong> (Full Funnel)</span>
      </div>
      ...
      <section className="relative pt-24 pb-20 px-6 z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <span>OMNIAGENTAI v2.0 • AUGUST 2026 EDITION</span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-tight max-w-4xl mx-auto"
          >
            The World's First Done-For-You AI Business Agent — <br />
            <span className="bg-gradient-to-r from-purple-600 via-fuchsia-600 to-indigo-600 bg-clip-text text-transparent font-extrabold leading-tight">
              <TypewriterText text="Now With Voice, Browser Control & Built-In Revenue Engine" delay={800} />
            </span>
          ...
          >
            <strong className="text-slate-950 font-extrabold">6 Original Agent Modes ENHANCED • 8 New Features ADDED</strong>. OmniAgentAI beats InstantlyClaw + BrowserAgent on every dimension, securing you 100+ personalized pitches weekly so you stay visible, trusted & selling.
          </motion.p>
